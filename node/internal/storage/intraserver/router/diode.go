...
func (d *OneToOne) Set(data *intra.UpdateMessage) {
...
func (d *OneToOne) TryNext() (*intra.UpdateMessage, bool) {
...
func (d *OneToOne) Next() *intra.UpdateMessage {
	readIndex := atomic.LoadUint64(&d.readIndex)
	idx := readIndex % uint64(len(d.buffer))
...
func (d *OneToOne) tryNext(idx uint64) (*intra.UpdateMessage, bool) {
...
func (d *OneToOne) pollBuffer(idx uint64) *intra.UpdateMessage {
	for {
...
type AlerterFunc func(missed int)

func (f AlerterFunc) Alert(missed int) {
	f(missed)
}
