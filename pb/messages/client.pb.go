...
const (
	...
	Client_InitWriteIndex Client_MessageType = 4
)
...
type Client struct {
	...
	InitWriteIndex   *InitWriteIndex     `protobuf:"bytes,6,opt,name=initWriteIndex" json:"initWriteIndex,omitempty"`
...
func (m *Client) GetInitWriteIndex() *InitWriteIndex {
	if m != nil {
		return m.InitWriteIndex
	}
	return nil
}
...
func (m *InitWriteIndex) Reset()         { *m = InitWriteIndex{} }
func (m *InitWriteIndex) String() string { return proto.CompactTextString(m) }
func (*InitWriteIndex) ProtoMessage()    {}

func (m *InitWriteIndex) GetFileId() uint64 {
	if m != nil && m.FileId != nil {
		return *m.FileId
	}
	return 0
...
func (m *InitWriteIndex) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *InitWriteIndex) GetIndex() int64 {
...
func (m *Client) Unmarshal(data []byte) error {
	...
	for index < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitWriteIndex", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if index >= l {
			...
			if m.InitWriteIndex == nil {
				m.InitWriteIndex = &InitWriteIndex{}
			}
			if err := m.InitWriteIndex.Unmarshal(data[index:postIndex]); err != nil {
				return err
			}
			index = postIndex
		default:
...
func (m *InitWriteIndex) Unmarshal(data []byte) error {
	l := len(data)
	index := 0
	for index < l {
		var wire uint64
...
func (m *InitWriteIndex) Size() (n int) {
	var l int
	_ = l
	if m.FileId != nil {
		n += 1 + sovClient(uint64(*m.FileId))
...
func (m *Client) MarshalTo(data []byte) (n int, err error) {
	...
	if m.InitWriteIndex != nil {
		data[i] = 0x32
		i++
		i = encodeVarintClient(data, i, uint64(m.InitWriteIndex.Size()))
		n4, err := m.InitWriteIndex.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *InitWriteIndex) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *InitWriteIndex) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
